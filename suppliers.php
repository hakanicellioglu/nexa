...
?>
        ...
        <section class="suppliers-layout">
            <div class="card form-card">
                ...
                <form id="supplier-add-form" autocomplete="off">
                    ...
                    <button type="submit" class="primary-button">Tedarikçiyi Kaydet</button>
        ...
        <script>
            ...
            const createRow = (supplier, index = null) => {
                ...
                indexCell.textContent = index !== null ? index : supplierTableBody.querySelectorAll('tr').length + 1;
            ...
            const refreshRowIndexes = () => {
                supplierTableBody.querySelectorAll('tr').forEach((row, rowIndex) => {
            ...
            addForm.addEventListener('submit', async (event) => {
                ...
                try {
                    ...
                    supplierTableBody.prepend(newRow);
                    refreshRowIndexes();
                } catch (error) {
            ...
            confirmDeleteButton.addEventListener('click', async () => {
                ...
                try {
                    ...
                    setTimeout(() => {
                        ...
                        if (supplierTableBody.querySelectorAll('tr').length === 0) {
